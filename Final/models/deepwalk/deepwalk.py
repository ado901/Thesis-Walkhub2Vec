...
class DeepWalk:
    ...
    def train(self, embed_size=128, window_size=5, workers=3, iter=5,node=-1, **kwargs):
        ...
        print(f"Learning embedding vectors with {node}...")
        model = Word2Vec(**kwargs)
        print(f"Learning embedding vectors with {node} done!")
