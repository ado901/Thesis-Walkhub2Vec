...
nodes={'id':[], 'Year':[], 'Label':[]}
edges=[]
#tutto sto casino perchè tolist() ritorna n liste da un solo valore
...
print(nodesdf)
with open('arxiv/nodes/nodescomplete.csv','w+', newline='')as fnodes:
...
with open('arxiv/edgescumulative/edges.csv','w+', newline='') as fedges:
